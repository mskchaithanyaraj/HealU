      ...
      <div className='how-to-use-main-container'>
        ...
        <div className="how-to-use-container">
          ...
          <div className="step-container">
            <h2 className="step-title">1. Introduce Yourself</h2>
          ...
          <div className="step-container">
            <h2 className="step-title">2. Specify Any Health Conditions</h2>
            <p className="step-description">
          ...
          <div className="step-container">
            <h2 className="step-title">3. Describe Your Food Preferences</h2>
            <p className="step-description">
          ...
          <div className="step-container">
            <h2 className="step-title">4. Indicate Meal Timing or Frequency</h2>
            <p className="step-description">
          ...
          <div className="step-container">
            <h2 className="step-title">5. Any Additional Details</h2>
            <p className="step-description">
